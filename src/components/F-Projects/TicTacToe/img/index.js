export { default as topRbottL } from './Group1.png';
export { default as topLbottR } from './Group2.png';
export { default as topLR } from './Group3.png';
export { default as midLR } from './Group4.png';
