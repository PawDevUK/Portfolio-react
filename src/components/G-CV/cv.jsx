        ...
        return (
            <div className="page">
                ...
                <section className="grid" id="know">
                    ...
                    <article id="art-know">
                        <p>Over last year I learned essentials of Web Development and <br></br>gained needed skills to develop websites.</p>
                        <p>Over last year I learned essentials of Web Development and <br></br>gained needed skills to develop websites.
                        Examples of work available in my portfolio at <a href="http://www.pawelsiwek.co.uk">PAWELSIWEK.CO.UK</a>
                        </p>
