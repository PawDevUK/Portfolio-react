import {GlobalBackground,shadow6,GlobalMain,h1Regular} from 'components/covid-app/components/styled'
import React,{useEffect,useState} from 'react'
import styled from 'styled-components'
import GlobalTotal from 'components/covid-app/store/total'
